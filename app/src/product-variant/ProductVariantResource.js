...
router.get("/", (0, HandleAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res
        .status(200)
        .json(yield productVariantService.get());
})));
router.get("/:id", (0, HandleAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res
        .status(200)
        .json(yield productVariantService.getById(Number(req.params.id)));
})));
router.post("/", (0, HandleAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res
        .status(201)
        .json(yield productVariantService.create(ProductVariantJson_1.ProductVariantJson.from(req.body)));
})));
router.put("/:id", (0, HandleAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res
        .status(200)
        .json(yield productVariantService.update(Number(req.params.id), ProductVariantJson_1.ProductVariantJson.from(req.body)));
})));
router.delete("/:id", (0, HandleAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield productVariantService.delete(Number(req.params.id));
    res.status(204).send();
})));
